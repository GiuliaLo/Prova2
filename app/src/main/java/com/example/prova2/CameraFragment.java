...
//            }
    ...
    private boolean onTap(float rawX, float rawY) {
        ...
        if (graphic != null) {
            ...
            if (text != null && text.getValue() != null) {
                Log.d(TAG, "TEXT FOUND: " + text.getValue());
                mListener.onFragmentInteraction(text.getValue());
            } else {
                Snackbar.make(mGraphicOverlay, "text data is null",
                        Snackbar.LENGTH_LONG)
                        .show();
            ...
            Snackbar.make(mGraphicOverlay, "no text detected",
                    Snackbar.LENGTH_LONG)
                    .show();
    ...
    public interface OnFragmentInteractionListener {
        void onFragmentInteraction(String parameter);
    }
